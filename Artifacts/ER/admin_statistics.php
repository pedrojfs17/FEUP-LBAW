    ...
    <div class="container-md">
        <div class="d-flex justify-content-between mt-3 stats-dashboard ">
            <div class="d-flex flex-column flex-grow-1 stats-block">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-lg-1">
                        <img class="img-fluid img-responsive shadow stats-block"
                    ...
                    <div class="col-lg-6 order-lg-2">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-9 order-lg-2">
                                <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: 53%"
                                         aria-valuenow="53" aria-valuemin="0" aria-valuemax="100">53%
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-9 order-lg-2">
                                <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: 5.3%"
                                         aria-valuenow="5.3" aria-valuemin="0" aria-valuemax="100">5.3%
                                    </div>
                                </div>
                            </div>
                        </div>
