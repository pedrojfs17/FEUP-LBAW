                    ...
                    <div class="card my-2">
                        <div class="card-body p-2">
                            <div class="d-flex">
                                ...
                                <div class="my-auto mx-3 flex-grow-1">
                                    <h5 class="my-0">Gonçalo Alves</h5>
                    ...
                    <div class="card my-2">
                        <div class="card-body p-2">
                            <div class="d-flex">
                                ...
                                <div class="my-auto mx-3 flex-grow-1">
                                    <h5 class="my-0">António Bezerra</h5>
                    ...
                    <div class="card my-2">
                        <div class="card-body p-2">
                            <div class="d-flex">
                                ...
                                <div class="align-self-center mx-2" data-bs-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample4">
                                    <i class="fas fa-ellipsis-v"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card my-2">
                        <div class="card-body p-2">
                            <div class="d-flex">
                                ...
                                <div class="my-auto mx-3 flex-grow-1">
                                    <h5 class="my-0">Inês Silva</h5>
                                    <p class="my-0">up201806385@fe.up.pt</p>
                                </div>
                                <div class="align-self-center mx-2" data-bs-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample5">
                                    <i class="fas fa-ellipsis-v"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card my-2">
                        <div class="card-body p-2">
                            <div class="d-flex">
                                ...
                                <div class="align-self-center mx-2" data-bs-toggle="collapse" href="#collapseExample6" role="button" aria-expanded="false" aria-controls="collapseExample6">
                                    <i class="fas fa-ellipsis-v"></i>
                                </div>
                            </div>
                        </div>
