...
<header class="masthead text-center text-white">
    <div class="masthead-content">
        <div class="container">
            ...
            <a href="sign_up.php" class="btn btn-primary btn-xl rounded-pill mt-5 mx-3">Join Oversee</a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 order-xl-1">
                    <div class="p-5">
                        ...
                        <p class="me-5 pe-5 fs-5">Oversee cards are your portal to more organized work—where every single part of your task can be managed, tracked, and shared with teammates. Open any card to uncover an ecosystem of checklists, due dates, conversations, and more.</p>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 order-xl-2">
                    <div class="p-5">
                        ...
                        <p class="ms-5 ps-5 fs-5">With all your data and insights in one place, you can see what’s working best and get recommendations to help you do more of it.</p>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 order-xl-1">
                    <div class="p-5">
                        ...
                        <p class="me-5 pe-5 fs-5">From the small stuff to the big picture, Oversee organizes work so teams know what to do, why it matters, and how to get it done.</p>
                    </div>
                </div>
                <div class="col-lg-4 order-lg-2">
                    <div class="p-5">
