...
<div class="container">
    <div class="row align-items-center mt-5">
        <h1><a class="fs-4 me-4" href="project_overview.php"><i class="bi bi-chevron-left"></i></a>Project Settings</h1>
    </div>
    ...
    <div class="row justify-content-center align-items-begin px-5">
        ...
        <label for="description" class="form-label">Description
            <input id="description" class="form-control" type="text" placeholder="In a nutshell, sourdough is slow-fermented bread. It’s unique because it does not require commercial yeast in order to rise.">
        </label>
    ...
    <div class="card mx-5 my-1">
        <div class="card-body">
            <img class="rounded-circle d-inline-block mx-2" src="images/avatar.png" width="40px" height="40px" alt="avatar">
