        ...
        <div class="row">
            ...
            <div class="col mb-3 task-group status-not-started">
                <div class="card">
                    ...
                    <div class="card-body ">
                        <div class="d-grid gap-2 ">
                            <div id="task3" class="btn text-start draggable" type="button" draggable="true">Prepare
                                description
                            </div>
                        </div>
                    </div>
            ...
            <div class="col mb-3 task-group status-in-progress">
                <div class="card">
                    ...
                    <div class="card-body ">
                        <div class="d-grid gap-2 ">
                            <div id="task4" class="btn text-start draggable" type="button" draggable="true">Feed the
                                culture
                            </div>
                        </div>
                    </div>
            ...
            <div class="col mb-3 task-group status-completed">
                <div class="card">
                    ...
                    <div class="card-body ">
                        <div class="d-grid gap-2 ">
                            <div id="task5" class="btn text-start draggable" type="button" draggable="true">Get
                                Ingredients
                            </div>
                        </div>
                    </div>
