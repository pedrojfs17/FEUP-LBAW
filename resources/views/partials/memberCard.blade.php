<div class="card my-1">
  <div class="card-body">
    ...
    @if (Auth::user()->is_admin)
      <button class="btn btn-danger float-end remove-button" data-href="/profile/{{ $member->account->username }}" type="button" style="z-index: 1; position:relative;">Remove</button>
    @endunless
  </div>
</div>
