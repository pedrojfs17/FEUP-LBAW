      ...
      <div class="modal-body d-grid gap px-sm-5">
        ...
        <div class="row gx-0">
          ...
          <div class="col-12 col-lg-6 ps-2">
            ...
            <img class="rounded-circle" src="{{ asset('images/avatar.png') }}" width="40px " height="40px "
                 alt="avatar ">
          </div>
          <hr>
        </div>
        <div>
          ...
          <a class="text-muted float-end edit-tags" data-bs-toggle="collapse" href=".multi-collapse" role="button"
          ...
          <div class="mb-3">
            <div class="comment mb-3">
              <div class="comment-body d-flex ms-2">
                <img class="rounded-circle mt-1" src="{{ asset('images/avatar.png') }}" width="30px" height="30px"
                     alt="avatar">
                ...
                <a class="p-1 mx-2 d-flex align-items-center" data-bs-toggle="collapse" href="#comment1reply"
                   role="button" aria-expanded="false" aria-controls="comment1reply">
              ...
              <div id="comment1reply" class="collapse">
                <div class="comment-replies my-2 ms-5">
                  <div class="comment-body d-flex ms-2">
                    ...
                    <div class="rounded-3 border py-2 px-3 position-relative flex-grow-1 ms-2"
                         style="background-color: #e7e7e7">
                      For this first post we only need these. Maybe for another one we need more but they are in another
                      task.
                    </div>
                  </div>
                </div>
            ...
            <div class="comment mb-4">
              <div class="comment-body d-flex ms-2">
                ...
                <a class="p-1 mx-2 d-flex align-items-center" data-bs-toggle="collapse" href="#comment2reply"
                   role="button" aria-expanded="false" aria-controls="comment2reply">
                  <i class="bi bi-chat-text fs-5 text-muted"></i>
                </a>
              </div>
